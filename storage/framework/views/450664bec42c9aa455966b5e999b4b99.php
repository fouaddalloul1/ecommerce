...
<head>
    ...
    <title>Horizon<?php echo e(config('horizon.name') ? ' - ' . config('horizon.name') : ''); ?></title>

    <!-- Style sheets-->
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=figtree:300,400,500,600" rel="stylesheet" />
    <?php echo e(Laravel\Horizon\Horizon::css()); ?>

    <?php echo e(Laravel\Horizon\Horizon::js()); ?>
...
<div id="horizon" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            <router-link to="/" class="logo d-flex align-items-center">
                ...
                <h1 class="h4 mb-0 ms-2">
                    <strong>Laravel</strong> Horizon<?php echo e(config('horizon.name') ? ' - ' . config('horizon.name') : ''); ?>
        ...
        <div class="row mt-4">
            ...
            <div class="col-10">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isDownForMaintenance): ?>
...
<?php /**PATH /home/kali/final_ecom/ff/ecommers-batch-queues-fixed/ecommers/vendor/laravel/horizon/src/../resources/views/layout.blade.php ENDPATH**/ ?>